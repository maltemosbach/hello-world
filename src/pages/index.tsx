...
const Title: React.FC = ({children}) => {
    ...
    return (
        <div className="mt-10">
            <h1 className="pb-1 mb-4 text-center text-left text-4xl">{children}</h1>
        </div>
    ...
    return (
        <div className="pb-12">
            ...
            <div className="flex justify-center content-center mt-4">
                <p className="text-justify font-normal text-base m-1 sm:m-1 max-w-2xl">{
                    children
                }</p>
            </div>
        </div>
    ...
    return (
        <span className="text-center inline-block mb-0 mt-0 leading-tight">
                <a href={website} target={"_blank"}
                   className="font-normal text-xl no-underline text-blue-600 hover:text-blue-800 underline-offset-3 hover:transition-all">
                    {children}
                </a>
            ...
            <main className="bg-gray-20">
                <Article>
                    ...
                    <div className="flex justify-center mt-4 mb-12">
                        <a href={""} className="inline-flex items-center text-blue-600 bg-gray-200 hover:bg-gray-300 rounded-r hover:text-blue-800 rounded-full text-center text-base pl-6 pr-1">
                        ...
                        <a href={""} target={!"".startsWith("#") ? "_blank" : "_self"} className="inline-flex items-center text-blue-600 bg-gray-200 hover:bg-gray-300 rounded-l hover:text-blue-800 rounded-full text-base pl-3 pr-4 pt-2 pb-2 text-center mr-6 text-bas border-l border-gray-100 font-normal">
                            PDF
                            <PiArrowUpRightBold />
                            {/* <MdOutlinePictureAsPdf className="ml-1" /> */}
                        </a>
                    ...
                    <div className="flex justify-left mt-4 text-base ">
                        We distill real-world deployable policies that are promptable via language or points by using SAM-2 as their interface. We distill real-world deployable policies that are promptable via language or points by using SAM-2 as their interface.
                    </div>

                    {/* Teaser Video */}
                    <video autoPlay controls muted playsInline loop alt="Teaser Video"
                           className="border-2 border-slate-100 mt-12 rounded-xl mx-auto max-w-[100%] sm:max-w-[70%]">
